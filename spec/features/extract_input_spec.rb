...
RSpec.describe "ExtractInput", :type => :request do
  ...
  describe "given the control instructions line" do
   
    it "should extract control instructions in a string" do
      expect(ExtractInput.new("LRMLR").control_instructions).to eq("LRMLR")
    end
